...
function NI_Card({ os_trip, adventure }) {
  ...
  const os_image = `/img/galleries/north_island/${card.image}`;
      ...
      <div className="group h-[500px]  w-72 [perspective:1000px]">
        <div className="relative w-full h-full shadow-xl rounded-xl transition-all duration-700 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]">
          <div className="relative w-full h-full">
            ...
            />
            <div
              className="absolute inset-0 bg-blue-800 opacity-50 h-1/2 rounded-xl "
              style={{ clipPath: "polygon(0 0, 100% 0, 100% 85%, 0 100%)" }}
            ></div>
            <div className="grid grid-cols-2 gap-8 pt-16 pl-8 text-blue-800">
          ...
          <div className="absolute inset-0 w-full h-full px-12 text-center bg-blue-800  rounded-xl text-slate-200 [transform:rotateY(180deg)] [backface-visibility:hidden]">
