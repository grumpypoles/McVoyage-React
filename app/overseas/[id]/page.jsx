...
const Page = () => {
  ...
  //   console.log(`Day Number: ${day.day_number}`);
  //   console.log(`Day Title: ${day.day_title}`);
  //   console.log(`Day Date: ${day.day_date}`);
  //   console.log(`Day Comment: ${day.day_comment}`);
  //   console.log(`Page: ${day.page}`);

  //   // Extract the day_link array
  // day.day_link.forEach((link) => {
  //   console.log(`Link: ${link.link}`);
  //   console.log(`Link Title: ${link.link_title}`);
  //   console.log(`Link Icon: ${link.link_icon}`);
  // });

  //   // Extract the day_image object
  //   const image = day.day_image;
  //   console.log(`Image: ${image.image}`);
  //   console.log(`Image Number: ${image.image_number}`);
  //   console.log(`Image Alt: ${image.image_alt}`);
  // });
